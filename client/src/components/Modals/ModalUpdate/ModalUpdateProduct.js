  ...
  return (
    ...
    >
      <Form onFinish={handlerFormUpdate}>
        <span>Tên hàng</span>
        <Form.Item name="name" initialValue={productEdit.name}>
          <Input placeholder="Nhập tên hàng" />
        </Form.Item>
        <span>Nhóm hàng</span>
        <Form.Item name="category" initialValue={productEdit.category._id}>
        ...
        <span>Đơn vị</span>
        <Form.Item name="unit" initialValue={productEdit.unit._id}>
          <Select placeholder="--Lựa chọn--">
            {listUnit.length > 0 ? (
              listUnit.map((unit) => (
        ...
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <div style={{ width: "30%" }}>
            <span>Giá nhập</span>
            <Form.Item name="moneyIn" initialValue={productEdit.moneyIn}>
              <InputNumber placeholder="Nhập giá" />
            </Form.Item>
          </div>
          <div style={{ width: "30%" }}>
            <span>Giá bán</span>
            <Form.Item name="moneyOut" initialValue={productEdit.moneyOut}>
              <InputNumber placeholder="Nhập giá bán" />
            </Form.Item>
          </div>
          <div style={{ width: "30%" }}>
            <span>Tồn kho</span>
            <Form.Item name="inventory" initialValue={productEdit.inventory}>
